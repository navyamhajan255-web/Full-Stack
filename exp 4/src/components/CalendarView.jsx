...
function CalendarView({
  ...
  const optimizationById = useMemo(
    () =>
      new Map(
        calendarOptimization.results.map(
          (result) => [
            result.id,
            result,
          ]
  ...
  return (
    <section
      ...
      aria-label="Post scheduling calendar"
    >
